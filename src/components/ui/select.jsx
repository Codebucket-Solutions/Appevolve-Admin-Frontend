...
function SelectItem({ className, children, ...props }) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full select-none cursor-default items-center gap-2 rounded-sm py-1.5 pl-2 pr-8 text-sm outline-hidden",
        "focus:bg-accent focus:text-accent-foreground",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "border-b border-[#D5D5D5] dark:border-[#323338] last:border-0",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        ...
        "bg-border border-[#D5D5D5] dark:border-[#323338]",
        className
      )}
      {...props}
    />
