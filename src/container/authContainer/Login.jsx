...
const Login = () => {
    return (
        <div className="flex w-full h-screen bg-black text-gray-200 font-sans">
            ...
            <div className="flex flex-col justify-center items-start w-[50vw] p-20 xl:p-20 dark:bg-[#000000] bg-white rounded-l-lg">
                <div className="flex items-center mb-10">
                    ...
                    <span className="text-gray-300 font-bold">IntellectCloud</span>
                </div>
                ...
                <form className="w-full">
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            className="w-full p-3 bg-black text-gray-200 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                    <div className="mb-4">
            ...
            <div className="relative w-full h-full flex flex-col pt-20 pl-42 overflow-hidden shadow-lg border-2">
                {/* Top Image */}
                {/* <img
                    src={right_top_img}
